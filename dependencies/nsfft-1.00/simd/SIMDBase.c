...
int inline posix_memalign(void **memptr, size_t alignment, size_t size){
...
#if defined(__i386__) || defined(__x86_64__) || defined(_WIN32) || defined (_WIN64)
...
#if defined (_MSC_VER)
	return aligned_malloc(size, SIMDBase_sizeOfCachelineInByte());
#else
	void *p;
