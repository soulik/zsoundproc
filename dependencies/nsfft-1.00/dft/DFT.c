...
DFT_EXPORT int32_t getModeParamInt_purec_float(int32_t paramId);
DFT_EXPORT int32_t getModeParamInt_purec_double(int32_t paramId);
DFT_EXPORT int32_t getModeParamInt_purec_longdouble(int32_t paramId);
DFT_EXPORT int32_t getModeParamInt_sse_float(int32_t paramId);
DFT_EXPORT int32_t getModeParamInt_sse2_double(int32_t paramId);
DFT_EXPORT int32_t getModeParamInt_neon_float(int32_t paramId);
DFT_EXPORT int32_t getModeParamInt_avx_float(int32_t paramId);
DFT_EXPORT int32_t getModeParamInt_avx_double(int32_t paramId);
DFT_EXPORT int32_t getModeParamInt_altivec_float(int32_t paramId);

DFT_EXPORT char * getModeParamString_purec_float(int32_t paramId);
DFT_EXPORT char * getModeParamString_purec_double(int32_t paramId);
DFT_EXPORT char * getModeParamString_purec_longdouble(int32_t paramId);
DFT_EXPORT char * getModeParamString_sse_float(int32_t paramId);
DFT_EXPORT char * getModeParamString_sse2_double(int32_t paramId);
DFT_EXPORT char * getModeParamString_neon_float(int32_t paramId);
DFT_EXPORT char * getModeParamString_avx_float(int32_t paramId);
DFT_EXPORT char * getModeParamString_avx_double(int32_t paramId);
DFT_EXPORT char * getModeParamString_altivec_float(int32_t paramId);

DFT_EXPORT void *makePlan_purec_float(uint64_t n, uint64_t flags);
DFT_EXPORT void *makePlan_purec_double(uint64_t n, uint64_t flags);
DFT_EXPORT void *makePlan_purec_longdouble(uint64_t n, uint64_t flags);
DFT_EXPORT void *makePlan_sse_float(uint64_t n, uint64_t flags);
DFT_EXPORT void *makePlan_sse2_double(uint64_t n, uint64_t flags);
DFT_EXPORT void *makePlan_neon_float(uint64_t n, uint64_t flags);
DFT_EXPORT void *makePlan_avx_float(uint64_t n, uint64_t flags);
DFT_EXPORT void *makePlan_avx_double(uint64_t n, uint64_t flags);
DFT_EXPORT void *makePlan_altivec_float(uint64_t n, uint64_t flags);

DFT_EXPORT void *makePlanSub_purec_float(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);
DFT_EXPORT void *makePlanSub_purec_double(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);
DFT_EXPORT void *makePlanSub_purec_longdouble(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);
DFT_EXPORT void *makePlanSub_sse_float(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);
DFT_EXPORT void *makePlanSub_sse2_double(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);
DFT_EXPORT void *makePlanSub_neon_float(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);
DFT_EXPORT void *makePlanSub_avx_float(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);
DFT_EXPORT void *makePlanSub_avx_double(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);
DFT_EXPORT void *makePlanSub_altivec_float(uint64_t n, int32_t radix2thres, int32_t useCobra, uint64_t flags);

DFT_EXPORT void destroyPlan_purec_float(void *p);
DFT_EXPORT void destroyPlan_purec_double(void *p);
DFT_EXPORT void destroyPlan_purec_longdouble(void *p);
DFT_EXPORT void destroyPlan_sse_float(void *p);
DFT_EXPORT void destroyPlan_sse2_double(void *p);
DFT_EXPORT void destroyPlan_neon_float(void *p);
DFT_EXPORT void destroyPlan_avx_float(void *p);
DFT_EXPORT void destroyPlan_avx_double(void *p);
DFT_EXPORT void destroyPlan_altivec_float(void *p);

DFT_EXPORT void execute_purec_float(void *p, void *s, int32_t dir);
DFT_EXPORT void execute_purec_double(void *p, void *s, int32_t dir);
DFT_EXPORT void execute_purec_longdouble(void *p, void *s, int32_t dir);
DFT_EXPORT void execute_sse_float(void *p, void *s, int32_t dir);
DFT_EXPORT void execute_sse2_double(void *p, void *s, int32_t dir);
DFT_EXPORT void execute_neon_float(void *p, void *s, int32_t dir);
DFT_EXPORT void execute_avx_float(void *p, void *s, int32_t dir);
DFT_EXPORT void execute_avx_double(void *p, void *s, int32_t dir);
DFT_EXPORT void execute_altivec_float(void *p, void *s, int32_t dir);
...
int32_t DFT_swrite(void *p2, std::ostream & stream) {
	DFTUndiff *p = (DFTUndiff *)p2;
	if (p->magic != MAGIC_DFT) abort();

	try {
		stream << "nsfft file format : " << FILE_FORMAT_VERSION << "\n";
		stream << "arch : " << SIMDBase_getProcessorNameString() << "\n";
		stream << "computation mode : " << p->mode << "\n";
		stream << "length : " << (((p->flags & DFT_FLAG_REAL) != 0 || (p->flags & DFT_FLAG_ALT_REAL) != 0) ? p->length * 2 : p->length) << "\n";
		stream << "radix2 threshold : " << p->radix2thres << "\n";
		stream << "transpose : " << p->flagTrans << "\n";
		stream << "bit reversal : " << p->useCobra << "\n";
	
		char hexNumber[64];
		sprintf(hexNumber, "%llx", (unsigned long long int)p->flags);

		stream << "flags : " << hexNumber << "\n";
		stream << "end :" << "\n";
	}
...
DFT *DFT_sread(std::istream & stream, int32_t *errcode) {
	...
	for (;;) {
		...
		try {
			...
			*errcode = DFT_ERROR_UNEXPECTED_EOF; return NULL;
		}
